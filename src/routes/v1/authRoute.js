...
router.get('/google/callback', catchAsync(authController.googleAuthCallback));
...
router.get('/check-username', validate(authValidation.checkUsername), catchAsync(authController.checkUsername));
